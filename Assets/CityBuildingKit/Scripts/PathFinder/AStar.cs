...
{   
    ...
    public static ArrayList FindPathForFlyingUnits(Node start, Node goal)//find path between start node and goal node
    {        
        openList = new PriorityQueue();
        openList.Push(start);
        start.nodeTotalCost = 0.0f;
        ...
        while (openList.Length != 0)//0
        {
            ...
            ArrayList neighbours = new ArrayList();
            GridManager.instance.GetNeighboursForFlyingUnits(node, neighbours);
